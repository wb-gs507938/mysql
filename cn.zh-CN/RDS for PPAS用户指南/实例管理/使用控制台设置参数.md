...
5.  在**可修改参数**标签页，您可以选择修改单个参数或批量修改参数，步骤如下：
    -   修改单个参数
        ...
        3.  单击**提交参数**。
        4.  在弹出的对话框中，单击**确定**。
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7895/15445948733045_zh-CN.png)
    ...
    -   批量修改参数
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7895/15445948733046_zh-CN.png)
...
请参见官方文档：[PPAS参数说明](https://www.postgresql.org/docs/10/static/runtime-config.html)
