# 增量备份数据上云SQL Server 2012/2016/2017版本 {#concept_bsg_zcw_ydb .concept}
...
如果您对业务停止时间不敏感（如2小时），当数据库小于100G时，建议您直接使用[全量备份数据上云SQL Server 2012/2016/2017版本](cn.zh-CN/用户指南SQL Server版/数据迁移/全量备份数据上云SQL Server 2012__2016__2017版本.md#)。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372116187_zh-CN.png)
...
2.  选择目标实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/154743721236543_zh-CN.png)
...
6.  如果您是第一次使用OSS备份数据恢复上云功能，需要给RDS官方服务账号授予访问OSS的权限：
    ...
    1.  单击数据导入向导第三项数据导入页面中的授权地址，如下图所示：
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372126199_zh-CN.png)
...
7.  授权完毕后，在数据导入向导第三步数据导入页面设置如下参数，单击**确认**生成OSS备份数据上云任务。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7998/15474372126114_zh-CN.png)
...
5.  单击右上角**OSS备份数据恢复上云**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372124345_zh-CN.png)
...
5.  在任务列表中找到待导入备份文件的记录，单击记录右侧的**打开数据库**，打开打开数据库窗口。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372124346_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372124347_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15474372124348_zh-CN.png)

## 常见错误 {#section_oqm_mlw_ydb .section}

全量备份数据上云中常见错误部分请参考[全量备份数据上云SQL Server 2012/2016/2017版本](cn.zh-CN/用户指南SQL Server版/数据迁移/全量备份数据上云SQL Server 2012__2016__2017版本.md#)。用户在增量上云过程中，还有可能会遇到下面的错误。
