...
4.  在左侧导航栏中单击**监控与报警**。
    ...
    **说明：** 数据库支持的监控项请参见文末的[监控项列表](#)

5.  选择**监控**标签页。
6.  单击**监控频率设置**。
7.  在弹出的监控频率设置对话框中，选择您需要的监控频率，本操作选则5秒/次的监控频率。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7952/15445944393104_zh-CN.png)

8.  单击确认打开确认更改对话框，单击**确认**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7952/15445944393105_zh-CN.png)

    若实例类型不支持秒级监控，在监控频率设置对话框中会给出提示。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41820/154459443933498_zh-CN.png)

9.  在监控页面中，您还可以执行如下操作：

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7952/15445944393107_zh-CN.png)
