...
6.  选择诊断类型，单击**查询**，即可在列表中查看到最近1个月内所诊断出的问题，如下图所示。
    ...
    **说明：** 系统只保留最近1个月内的数据，超时数据会被自动删除。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7909/15327472473070_zh-CN.png)

7.  若你要查看诊断详情，单击目标问题所对应操作栏中的**查看详情**，如下图所示。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7909/15327472473071_zh-CN.png)
