...
2.  选择目标实例所在地域。
    ...
    ![地域截图](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7882/154746001537169_zh-CN.png)
...
4.  在页面最下方的使用量统计栏中，查看备份使用量后面的备注信息，即为免费额度，如下图所示。
    ...
    **说明：** 不同类型实例显示的免费额度信息不同，下图仅为示例，请以实际界面为准。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7965/15474600154106_zh-CN.png)
