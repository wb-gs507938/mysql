...
-   当前仅 RDS for SQL Server 2008 R2 实例支持SQL审计功能。
-   开启SQL审计功能之前的记录无法查看到。
...
5.  选择**SQL审计**页签，单击**开启SQL审计**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7947/154469292221214_zh-CN.png)
...
6.  导出文件后单击**关闭SQL审计**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7947/154469292234230_zh-CN.png)
