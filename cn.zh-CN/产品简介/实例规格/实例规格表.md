...
|--|--|---|----|------|-----|------|----|
|基础版|2012 企业版|通用型|rds.mssql.s2.large|2核 4GB|不限制|IOPS=min\{30 x 磁盘容量，20000\}|20GB-2000GB|
...
|2012 Web版、2016 Web版|独享型|mssql.x2.medium.w1|2核 4GB|不限制|IOPS=min\{30 x 磁盘容量，20000\}|20GB-2000GB|
...
|2012企业版、2016企业版|独享型|mssql.x4.xlarge.e2|8核 32GB|无限制|取决于SSD云盘性能|20GB - 2TB|
...
|2012标准版、2016标准版|独享型|mssql.x4.medium.s2|2核 8GB|
