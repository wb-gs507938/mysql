...
-   规格类型：分为通用型、独享型、独享物理机型。关于各个规格类型的介绍，请参考[实例规格概述](intl.zh-CN/产品简介/实例规格/实例规格概述.md)。
...
-   [API](../../../../intl.zh-CN/API参考/使用API/API概览.md)：您也可以通过调用API来管理RDS实例，控制台上的所有操作都可以通过调用API来实现。
