...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7944/15343250104743_en-US.png)
...
-   The current access mode is safe connection mode. For more information on how to switch the access mode, see [Set access mode](https://help.aliyun.com/document_detail/26193.html). MySQL 5.7, SQL Server 2012, and SQL Server 2016 only support standard mode, but these instances also support hybrid access in this condition.
-   The current network type is classic network.
-   There are available VPC and VSwitch in the zone where the RDS instance is located. If not, create them by referring to [Create VPC](https://help.aliyun.com/document_detail/53604.html) and [Create VSwitch](https://help.aliyun.com/document_detail/53670.html).
...
7.  Check **Reserve original classic endpoint**, and select the **Expiration time** for the basic intranet IP address of the original network, as shown in the following figure.
    ...
    **Note:** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7944/15343250104745_en-US.png)

8.  Click **OK**.

    The **Original classic endpoint** area is displayed, as shown in the following figure.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7944/15343250104747_en-US.png)
...
5.  On the Instance Connection tab page, click **Change Expiration time**, as shown in the following figure.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7944/15343250104748_en-US.png)
