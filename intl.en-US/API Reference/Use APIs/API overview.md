# API overview {#reference_t1c_3hl_zdb .reference}
...
|[Copy databases for SQL Server 2008 R2](intl.en-US/API Reference/API Reference/Database management/Copy a database for SQL Server 2008 R2.md#)|Copy a database in SQL Server 2008 R2.|
