...
|--|--|---|----|------|-----|------|----|
|基础版|5.7|通用型|mysql.n1.micro.1|1核 1GB|2000|IOPS = min\{30\*磁盘容量, 20000\}|20GB-1000GB|
...
|系列|版本|规格族|规格代码|CPU和内存|最大连接数|最大IOPS|存储空间|
|--|--|---|----|------|-----|------|----|
|基础版|2012企业版|通用型|rds.mssql.s2.large|2核 4GB|不限制|IOPS = min\{30 x 磁盘容量, 20000\}|20GB-3000GB|
