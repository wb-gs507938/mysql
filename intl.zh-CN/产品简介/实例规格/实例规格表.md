...
|--|--|---|----|------|-----|------|----|
|基础版|支持5.7|通用|mysql.n1.micro.1|1核 1GB|2000| ```
IOPS=min{30*磁盘容量，20000}
```
...
|高可用版|支持5.5/5.6/5.7|通用|rds.mysql.t1.small|1核 1GB|300|600|5GB-2000GB|
...
|mysql.x8.2xlarge.2|16核 128GB|20000|36000|2000GB或3000GB|
|独享型（高CPU）|mysql.x4.large.2|4核 16GB|2500|4500|250GB或500GB|
|mysql.x4.xlarge.2|8核 32GB|5000|9000|500GB或1000GB|
|mysql.x4.2xlarge.2|16核 64GB|10000|18000|1000GB、2000GB或3000GB|
|mysql.x4.4xlarge.2|32核 128GB|20000|36000|2000GB或3000GB|
...
|只读实例|支持5.6/5.7|通用|rds.mysql.t1.small|1核 1GB|300|600|5GB-2000GB|
|rds.mysql.s1.small|1核 2GB|600|1000|
|rds.mysql.s2.large|2核 4GB|1200|2000|
|rds.mysql.s2.xlarge|2核 8GB|2000|4000|
|rds.mysql.s3.large|4核 8GB|2000|5000|
...
|mysqlro.x8.2xlarge.1|16核 128GB|20000|36000|2000GB或3000GB|
|独享型（高CPU）|mysqlro.x4.large.1|4核 16GB|2500|4500|250GB或500GB|
|mysqlro.x4.xlarge.1|8核 32GB|5000|9000|500GB或1000GB|
|mysqlro.x4.2xlarge.1|16核 64GB|10000|18000|1000GB、2000GB或3000GB|
|mysqlro.x4.4xlarge.1|32核 128GB|20000|36000|2000GB或3000GB|
|独占物理机|rds.mysql.st.d13|30核 220GB|64000|20000|3000GB|
...
|系列|版本|规格族|规格代码|CPU和内存|最大连接数|最大IOPS|存储空间|
|--|--|---|----|------|-----|------|----|
|基础版|支持2012 企业版|通用型|rds.mssql.s2.large|2核 4GB|不限制| ```
IOPS=min{30*磁盘容量，20000}
```
...
|支持2012 Web版、2016 Web版|独享型|mssql.x2.medium.w1|2核 4GB|不限制| ```
IOPS=min{30*磁盘容量，20000}
```
...
|高可用版|支持2008 R2|通用型|rds.mssql.s1.small|1核 2GB|600|1000|10GB-2000GB|
