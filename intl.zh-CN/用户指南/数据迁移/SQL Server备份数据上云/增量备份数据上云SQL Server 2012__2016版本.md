...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966926187_zh-CN.png)

[（单击查看全图）](./http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966926187_zh-CN.png)
...
6.  如果您是第一次使用OSS备份数据恢复上云功能，需要给RDS官方服务账号授予访问OSS的权限：
    ...
    1.  单击数据导入向导第三项数据导入页面中的授权地址，如下图所示：
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966926199_zh-CN.png)
...
7.  授权完毕后，在数据导入向导第三步数据导入页面设置如下参数，单击**确认**生成OSS备份数据上云任务。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7998/15431966926114_zh-CN.png)
...
4.  单击右上角**OSS备份数据恢复上云**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966924345_zh-CN.png)
...
5.  在任务列表中找到待导入备份文件的记录，单击记录右侧的**打开数据库**，打开打开数据库窗口。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966924346_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966924347_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7996/15431966924348_zh-CN.png)
