...
暂不支持按量付费，只支持包年包月的付费方式。

## 操作步骤 {#section_gj3_5rq_ngb .section}

1.  登录[RDS管理控制台](https://rds.console.aliyun.com)。
2.  在实例列表页面，单击**创建实例**。
3.  选择**包年包月**计费方式。

    **说明：** **包年包月**属于预付费，即在新建实例时需要支付费用。适合长期需求，价格比按量付费更实惠，且购买时长越长，折扣越多。
...
|
 ...
 |
    ...
    |网络类型|无需选择。目前MariaDB仅支持专有网络。    -   经典网络：传统的网络类型。
...
![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/154812553036543_zh-CN.png)
