...
4.  在续费页面中，选择续费时长。时间越长，折扣越多。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7889/154458446111150_zh-CN.png)
...
2.  在控制台右上方，选择**费用** \> **续费管理**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7890/154458446111148_zh-CN.png)

3.  在页面左侧单击**云数据库RDS版**。
4.  在手动续费、自动续费或到期不续费页签中，勾选多个实例，单击**批量续费**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7889/154458446111151_zh-CN.png)
...
[开通或修改自动续费](intl.zh-CN/RDS for MariaDB用户指南/计费管理/开通或修改自动续费.md#)
